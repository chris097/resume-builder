...
const ResumeSection = () => {
  ...
  const tabs: { tab: number; name: string, icon: any, has_data: any}[] = [
    { tab: 1, has_data: false, name: "Personal Information", icon: <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="17" height="17" fill="white"/>
    ...
    { tab: 2, has_data: false, name: "Experience", icon: <svg width="19" height="22" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5.78005 20.2031H1C1 16.1935 4.32905 12.943 8.43563 12.943C8.61419 12.943 8.79127 12.9491 8.96675 12.9612M12.6846 5.68284C12.6846 7.97408 10.7822 9.83149 8.43563 9.83149C6.08901 9.83149 4.1867 7.97408 4.1867 5.68284C4.1867 3.39159 6.08901 1.53418 8.43563 1.53418C10.7822 1.53418 12.6846 3.39159 12.6846 5.68284ZM10.1244 20.2031L12.2754 19.7831C12.463 19.7465 12.5568 19.7281 12.6442 19.6946C12.7218 19.6649 12.7956 19.6264 12.864 19.5798C12.941 19.5273 13.0086 19.4613 13.1439 19.3292L17.56 15.0173C18.1467 14.4445 18.1467 13.5158 17.56 12.943C16.9734 12.3702 16.0222 12.3702 15.4355 12.943L11.0194 17.2549C10.8842 17.387 10.8165 17.453 10.7628 17.5283C10.7151 17.595 10.6757 17.6671 10.6452 17.7429C10.6109 17.8282 10.5922 17.9198 10.5546 18.1029L10.1244 20.2031Z" stroke="#000112" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    { tab: 3, has_data: false, name: "Technical Skills", icon: <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
, },
    { tab: 4, has_data: false, name: "Education", icon: <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
, },
//     { tab: 5, has_data: false, name: "Contact Information", icon: <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
// <path d="M10 17.1666H0V14.25C0 12.25 1.08333 10.5 2.66667 9.58329C2.08333 8.99996 1.66667 8.16663 1.66667 7.24996C1.66667 5.41663 3.16667 3.91663 5 3.91663C6.83333 3.91663 8.33333 5.41663 8.33333 7.24996C8.33333 8.16663 8 8.99996 7.33333 9.58329C8.91667 10.5 10 12.3333 10 14.25V17.1666ZM1.66667 15.5H8.33333V14.25C8.33333 12.25 6.83333 10.5 5 10.5C3.25 10.5 1.66667 12.25 1.66667 14.25V15.5ZM5 5.49996C4.08333 5.49996 3.33333 6.24996 3.33333 7.16663C3.33333 8.08329 4.08333 8.83329 5 8.83329C5.91667 8.83329 6.66667 8.08329 6.66667 7.16663C6.66667 6.24996 5.91667 5.49996 5 5.49996ZM20 14.6666H11.6667V13H20V14.6666ZM17.5 11.3333H11.6667V9.66663H17.5V11.3333ZM20 7.99996H11.6667V6.33329H20V7.99996Z" fill="#4E4D4D"/>
// </svg>
// , },
    { tab: 5, has_data: false, name: "Certification", icon: <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <>
      <div className="w-full relative">
        <div className="fixed flex w-[45%] bg-primarygray">
          <div className="w-[270px] bg-white h-screen pt-10">
            {tabs.map((tab, index) => (
              <button
                key={index}
                onClick={() => {
                ...
                disabled={tab.has_data === true}
                className={`mt-5 ${currentTab === index + 1 ? "bg-corered/20 font-medium" : ""} 
                ${tab.has_data === false && "disabled:cursor-not-allowed"}
              ...
              <p className="text-sm text-coregray px-10 font-poppins mt-[50%]">Progress</p>
          ...
          <div className="w-[60%] bg-primarygray px-8 h-screen">
            {
              (tabs[currentIndex].tab === 1 && <UserInfo handleClick={() => selectTags(1,2)} />) ||
          ...
          {/* <div className="border-b pt-2 w-[200px] mr-6 text-xs justify-between items-center text-basegray">
            {tabs.map((tab, index) => (
              <div
                key={index}
                onClick={() => {
        ...
        {/* <div className="w-3/6 mt-7 ml-[43%] bg-white">
            <About />
          </div> */}
      </div>
    </>
